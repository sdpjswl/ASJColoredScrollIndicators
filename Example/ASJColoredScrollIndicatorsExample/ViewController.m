...
- (void)setupTextView
{
    _trueLoveWaitsTextView.contentInsetAdjustmentBehavior = UIScrollViewContentInsetAdjustmentAutomatic;
...
- (void)setupTableViews
{
    ...
    _okComputerTableView.contentInsetAdjustmentBehavior = UIScrollViewContentInsetAdjustmentAutomatic;
    ...
    _inRainbowsTableView.contentInsetAdjustmentBehavior = UIScrollViewContentInsetAdjustmentAutomatic;
...
- (void)setupCollectionViews
{
    _radioheadAlbumsCollectionView.contentInsetAdjustmentBehavior = UIScrollViewContentInsetAdjustmentAutomatic;
